...
background_image_urls = [
    ...
    "http://www.bom.gov.au/products/radar_transparencies/IDR763.background.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR763.topography.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR763.locations.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR763.range.png",
]
...
urlImages = "http://www.bom.gov.au/products/IDR763.loop.shtml"
...
image_names = re.findall(r'/radar/IDR763\.T\.\d{12}\.png', script_element.string)
