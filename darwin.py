...
background_image_urls = [
    ...
    "http://www.bom.gov.au/products/radar_transparencies/IDR633.background.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR633.topography.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR633.locations.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR633.range.png",
]
...
urlImages = "http://www.bom.gov.au/products/IDR633.loop.shtml"
...
image_names = re.findall(r'/radar/IDR633\.T\.\d{12}\.png', script_element.string)
