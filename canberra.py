...
background_image_urls = [
    ...
    "http://www.bom.gov.au/products/radar_transparencies/IDR403.background.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR403.topography.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR403.locations.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR403.range.png",
]
...
urlImages = "http://www.bom.gov.au/products/IDR403.loop.shtml"
...
image_names = re.findall(r'/radar/IDR403\.T\.\d{12}\.png', script_element.string)
