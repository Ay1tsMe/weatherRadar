...
background_image_urls = [
    ...
    "http://www.bom.gov.au/products/radar_transparencies/IDR713.background.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR713.topography.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR713.locations.png",
    "http://www.bom.gov.au/products/radar_transparencies/IDR713.range.png",
]
...
urlImages = "http://www.bom.gov.au/products/IDR713.loop.shtml"
...
image_names = re.findall(r'/radar/IDR713\.T\.\d{12}\.png', script_element.string)
